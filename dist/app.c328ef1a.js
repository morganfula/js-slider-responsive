...
var getScrollPercentage = function getScrollPercentage() {
...
slider.parentElement.addEventListener('scroll', function (e) {
  progressBar.style.width = "".concat(getScrollPercentage(), "%");
});
